...
A dot plot was created to visualize the top 30 biological processes enriched among CESA knockout DEGs, incorporating gene ratio, gene count, and -log10 FDR values. This figure directly addressed the research question by identifying statistically significant biological processes, such as secondary metabolism, ethylene signaling, and cell wall biogenesis, that were activated in response to CESA disruption.
